 ...
 */
fun dealCards(trickNS: List<List<CardPlayed>>,tricksEW: List<List<CardPlayed>>,cut: Int,spread: Triple<Int,Int,Int>,dealerPosition: PlayerPosition) : List<List<Card>> {
    ...
    val fourHands = mutableListOf<MutableList<Card>>(ce,code,nest,pasbeau)		// Liste des 4 futures mains
    var pos = mapPos[dealerPosition]!! - sens					// Premier à qui l'on donne
    val (a,b,c) = spread
    val lpread = mutableListOf<Int>(a,b,c)
    var curCard = cut	// La carte n°cut sera la première carte donnée (0 sinon), cela correspond à cut cartes dessous
