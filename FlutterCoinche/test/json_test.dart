...
void main() {
  test("Parses allGames.json", () {
    const jsonString = """[{"id":"NGfygSoelRxeF04SHcaU","nbJoined":4,"name":"AUTOMATEDme","nicknameCreator":"Jess","state":"PLAYING","inRoom":true},{"id":"hOnpWLvxKSEjD9ppz7vT","nbJoined":1,"name":"gameboy","nicknameCreator":"ieok","state":"JOINING","inRoom":false},{"id":"pcxbJ6Ehd27W7F90uihW","nbJoined":1,"name":"AAAutomated","nicknameCreator":"ieok","state":"JOINING","inRoom":false}]""";
    expect(
